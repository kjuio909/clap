...
complete -c my-app -n "__fish_my_app_using_subcommand help; and not __fish_my_app_using_subcommand help test; and not __fish_my_app_using_subcommand help help" -f -a "test" -d 'Subcommand with a second line'
complete -c my-app -n "__fish_my_app_using_subcommand help; and not __fish_my_app_using_subcommand help test; and not __fish_my_app_using_subcommand help help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
