...
complete -c my-app -n "__fish_my_app_using_subcommand help; and not __fish_my_app_using_subcommand help foo; and not __fish_my_app_using_subcommand help bar; and not __fish_my_app_using_subcommand help help" -f -a "foo"
complete -c my-app -n "__fish_my_app_using_subcommand help; and not __fish_my_app_using_subcommand help foo; and not __fish_my_app_using_subcommand help bar; and not __fish_my_app_using_subcommand help help" -f -a "bar"
complete -c my-app -n "__fish_my_app_using_subcommand help; and not __fish_my_app_using_subcommand help foo; and not __fish_my_app_using_subcommand help bar; and not __fish_my_app_using_subcommand help help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
