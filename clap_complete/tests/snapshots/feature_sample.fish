...
complete -c my-app -n "__fish_my_app_using_subcommand help; and not __fish_my_app_using_subcommand help test; and not __fish_my_app_using_subcommand help help" -f -a "test" -d 'tests things'
